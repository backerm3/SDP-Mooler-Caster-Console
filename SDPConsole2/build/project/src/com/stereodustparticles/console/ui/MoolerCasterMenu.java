	...
	public MoolerCasterMenu() {
		...
		about.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent arg0) {
				Microwave.showInfo("About the Mooler Caster Console", "SDP Mooler Caster Console\nVersion " + SDPConsole2.PROG_VERSION + "\n\nWritten for the Stereo Dust Particles group of broadcasters by Ben Ackerman (IfYouLikeGoodIdeas), 2016-17\n\nIncludes DTC playout technology, © 2017 Ben Ackerman/Stereo Dust Particles.  Mooler Caster Console and Stream 'n' Poop are trademarks of Stereo Dust Particles.  Not that anyone else would even think about using such silly names anyway...");
			}
