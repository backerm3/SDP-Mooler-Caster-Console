 ...
 * 
 * PrefObj: Allows arbitrary objects to be stored/loaded via the Preferences API
 * 
 * This class was obtained from IBM developerWorks, at the following page:
 * https://www.ibm.com/developerworks/library/j-prefapi/index.html
 * NOTE: Package declaration was changed to match the rest of the application
 */
...
public class PrefObj
{
  ...
  static private byte[][] readPieces( Preferences prefs, String key )
    ...
    // NOTE: Edited to handle case of no value written previously
	Preferences node;
	try {
    	node = prefs.node( key );
    }
