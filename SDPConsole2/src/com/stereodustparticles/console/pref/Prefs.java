...
public class Prefs {
	...
	private static HashMap<String, Library> getDefaultLibraryList() {
		...
		try {
			defaultLibs.put("SDP Ads", new CSVLibrary("SDP Ads", new URL("http://www.stereodustparticles.com/sdp-ads/ads.csv"), PlaylistFlags.AD));
			defaultLibs.put("SDP Other Media", new CSVLibrary("SDP Other Media", new URL("http://www.stereodustparticles.com/othermedia/othermedia.csv"), PlaylistFlags.NONE));
		}
